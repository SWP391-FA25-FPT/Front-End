...
export default function AdminSidebar({ collapsed, toggleCollapsed }) {
  ...
  const selectedKey = useMemo(() => {
    ...
    if (
      path === "/admin/content-moderation/recipes" ||
      path === "/admin/content-moderation"
    )
      return "admin-content-recipes";
    if (path === "/admin/content-moderation/blogs")
      ...
      children: [
        {
          ...
          icon: <Icon icon="mdi:food-outline" width="20" height="20" />,
          label: "Recipes",
        ...
        },
        {
          ...
          icon: (
            <Icon icon="mdi:newspaper-variant-outline" width="20" height="20" />
          ),
          label: "Blogs",
