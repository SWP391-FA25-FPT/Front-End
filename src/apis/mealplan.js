...
export const generateMealPlan = async (date) => {
  try {
    const response = await apiHelper.post(`${baseUrl}/api/mealplans/generate`, { date });
    return response;
  } catch (error) {
 ...
 */
export const regenerateMealPlan = async (date) => {
  try {
    const response = await apiHelper.post(`${baseUrl}/api/mealplans/regenerate`, { date });
    return response;
  } catch (error) {
